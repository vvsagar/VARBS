...
# Vidya's Auto Rice Bootstrapping Script (VARBS)
# by Vidya Sagar VOBBILISETTI <mail@vidyasagarv.com>
...
https://github.com/LukeSmithxyz/LARBS/commits/master.atom \"~LARBS install scripts\""
